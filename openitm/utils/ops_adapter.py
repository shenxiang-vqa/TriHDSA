...
class OpsAdapter:
    def __init__(self):
        ...
        self.OPS = {
            ...
            'T_self_att_64': lambda __C, norm, residual: TSelfAtt(__C, norm, residual, base=64),
            ...
            'T_guided_att_64': lambda __C, norm, residual: TGuidedAtt(__C, norm, residual, base=64),
